...
class Worker(QThread):
    ...
    def run(self):
        ...
        try:    
            ...
            bookImg = driver.find_element_by_xpath('//*[@id="container"]/div[2]/form/div[2]/div[1]/div/a/img')
            print(bookImg)
            src = bookImg.get_attribute('src')
            print(src)
        ...
        urllib.request.urlretrieve(src,savedDir+"image.png")
